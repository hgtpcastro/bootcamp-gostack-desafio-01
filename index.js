...
/**
 *  A função express() é uma função de nível superior exportada pelo 
 *  módulo express
 */
const server = express();

/**
 * Middleware do express, que faz o parse das requisições em formato JSON
 */
...
function checkProjectExists(req, res, next) {
  ...
  /**
   * Altera os dados da requisição para receber o parametro id, podendo o mesmo
   * ser usado de uma forma mais elegante pelas rotas
   */
  req.id = id;
...
/**
 * Aplica o middleware de forma global
 */
